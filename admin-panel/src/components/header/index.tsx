...
// Map backend/user-facing role strings → canonical RoleSlug
const ROLE_MAP: Record<string, RoleSlug> = {
  // Super admin
  SUPERADMIN: "SUPER_ADMIN",
  "SUPER_ADMIN": "SUPER_ADMIN",
  "SUPER ADMIN": "SUPER_ADMIN",
  ADMIN: "SUPER_ADMIN", // if backend just sends "admin"
...
function getUserRole(): RoleSlug | null {
  try {
    ...
    // try multiple fields – most important is usertype for you
