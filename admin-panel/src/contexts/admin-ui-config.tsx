...
const normalizeUiResources = (resources: UiResource[]): UiResource[] => {
  ...
  // even when the DB menu cache is stale. Permission checks still decide visibility.
    ...
    screen: "Direct Trade Orders",
    element: "Direct Trade orders menu",
    ui_type: "MENU",
    ...
    screen: "Operations Control Centre",
    element: "Mandi Manager operations menu",
    ui_type: "MENU",
    route: "/operations",
    parent_resource_key: null,
    allowed_actions: ["VIEW"],
    ...
    order: 11,
    icon_key: "operations",
    i18n_label_key: "menu.mandiOperations",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
  ensure({
    resource_key: "mandi_approvals.menu",
    screen: "Approval Centre",
    element: "Mandi Manager approvals menu",
    ui_type: "MENU",
    route: "/approvals",
    parent_resource_key: null,
    allowed_actions: ["VIEW"],
    ...
    order: 12,
    icon_key: "approval",
    i18n_label_key: "menu.mandiApprovals",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
  ensure({
    resource_key: "mandi_staff.menu",
    screen: "Staff & Operations Team",
    element: "Mandi Manager staff menu",
    ui_type: "MENU",
    route: "/staff",
    parent_resource_key: null,
    allowed_actions: ["VIEW"],
    ...
    order: 13,
    icon_key: "staff",
    i18n_label_key: "menu.mandiStaff",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
  ensure({
    resource_key: "mandi_staff.list",
    screen: "Staff & Operations Team",
    element: "Operational staff list",
    ui_type: "TABLE",
    route: "/staff",
    parent_resource_key: "mandi_staff.menu",
    allowed_actions: ["VIEW"],
    is_active: true,
    order: 14,
    icon_key: "staff",
    i18n_label_key: "screen.mandiStaff.list",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
  ensure({
    resource_key: "mandi_reports.menu",
    screen: "Reports & MIS",
    element: "Mandi Manager reports menu",
    ui_type: "MENU",
    ...
    order: 14,
    icon_key: "reports",
    i18n_label_key: "menu.mandiReports",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
  ensure({
    resource_key: "mandi_management.menu",
    screen: "Mandi Management",
    element: "Mandi Manager management menu",
    ui_type: "MENU",
    ...
    order: 15,
    icon_key: "mandi",
    i18n_label_key: "menu.mandiManagement",
    metadata: { injected: true, group: "Operations" },
  } as UiResource);
