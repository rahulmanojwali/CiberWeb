  ...
  const columns = useMemo<GridColDef<VehicleRow>[]>(
    () => [
      { field: "vehicle_type_code", headerName: "Code", width: 150 },
      {
        ...
        headerName: "Name",
        flex: 1,
        valueGetter: (params) => params.row?.name_i18n?.en || params.row.vehicle_type_code,
      },
      {
        field: "is_allowed",
        headerName: "Allowed",
        width: 120,
        valueGetter: (params) => (params.row?.is_allowed === "Y" ? "Yes" : "No"),
      },
      {
        field: "requires_permit",
        headerName: "Permit",
        width: 120,
        valueGetter: (params) => (params.row?.requires_permit === "Y" ? "Required" : "No"),
      },
      {
        field: "is_active",
        headerName: "Active",
        width: 110,
        valueGetter: (params) => (params.row?.is_active === "Y" ? "Yes" : "No"),
      },
      {
        field: "actions",
        headerName: "Actions",
