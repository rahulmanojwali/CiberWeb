...
// Pairing (Admin) - generate a short-lived pairing code for a device
export const generateGateDevicePairCode = async ({
  username,
  language = DEFAULT_LANGUAGE,
  device_id,
  ttl_minutes = 10,
  ...
  callEncrypted(API_ROUTES.admin.generateGateDevicePairCode, {
    api: API_TAGS.GATE_DEVICE_PAIRING.generate,
    username,
    language,
    device_id,
    ttl_minutes,
